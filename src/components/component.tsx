  ...
  return (
    <section className="w-full grid grid-cols-1 md:grid-cols-3 gap-4 py-12 md:py-24 lg:py-32 bg-white dark:bg-black">
      <div className="flex flex-col items-center justify-center space-y-4">
        ...
        <p className="text-sm text-zinc-400 dark:text-zinc-500">Web Developer</p>
        <p className="text-sm text-zinc-400 dark:text-zinc-500">San Francisco, CA</p>
        ...
        <div className="flex items-center mt-4">
          <p className="text-sm text-zinc-400 dark:text-zinc-500 mr-2">Switch to:</p>
      ...
      <div className="flex flex-col items-center justify-center space-y-4 mt-4 md:mt-0">
        <div className="hidden">
          <p className="text-sm text-zinc-400 dark:text-zinc-500">Guitar</p>
          <p className="text-sm text-zinc-400 dark:text-zinc-500">Drums</p>
          <p className="text-sm text-zinc-400 dark:text-zinc-500">Piano</p>
        </div>
      </div>
      <div className="flex flex-col items-start space-y-4 mt-4 md:mt-0">
        <h3 className="text-xl font-bold mb-4 text-black dark:text-white">Projects</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="w-full rounded-lg shadow-md bg-zinc-800 dark:bg-white p-4">
            <Link className="text-sm text-zinc-400 dark:text-zinc-500 underline" href="#">
              Project 1
            </Link>
          </div>
          <div className="w-full rounded-lg shadow-md bg-zinc-800 dark:bg-white p-4">
